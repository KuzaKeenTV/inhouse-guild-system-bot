...
const { prefix, SPREADSHEET_ID, adminRole, embedColor } = require("../config.js"); // Make sure SPREADSHEET_ID is imported
const getGuildPoints = require("../utils/getGuildPoints.js");
const setGuildPoints = require("../utils/setGuildPoints.js");

module.exports = {
  name: "give",
  description: "Give points to a specified guild.",
  usage: `${prefix}give @role <TEAM A/TEAM B> <amount>`,
  execute: async (message, args) => {
    ...
    const resultEmbed = new MessageEmbed()
      .setColor(embedColor)
      .setDescription(`Added **${amount} point(s)** to ${type.toUpperCase()} of ${mentionedRole}. They now have **${currentPoints.totalPoints} point(s)**.`);
